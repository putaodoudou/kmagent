...
[KMAgent](http://kmagent.com) 以 **个人知识管理 GTD** 应用为主的个人工具软件。基于交互区+文档的协同学习工作空间，专注于语义计算、知识工程。致力于通过最新技术+社群协同，简化知识增强认知、融合支持优秀方法论模板，辅助高效学习工作，增强个人能力，开源项目结合产学研，协同积累创新，节省时间精力，从知识中挖掘智慧。您的私人知识引擎、秘书、智友、智囊团。
...
> **以产品应用为主**，理论技术知识能力实践闭环正反馈迭代积累的过程，人与人与机器机器的合作学习！
...
> 我们是一个快速成长的协同学习型组织，项目处于初期规划阶段，**欢迎各位有志之士的加入！**

基于共同信念、统一基础、协同机制，自由分工自组织工作组，根据 [规则](https://github.com/GYGit/KiMi/blob/master/0-team-社群/rules贡献积分规则.md) 记录贡献积分，按贡献分配奖励，未来若盈利可分红，涌现集体智慧！收获积分朋友知识工具技术。

关注公众号或加入微信群以获取最新消息及文章、参与讨论、联系加入我们。

1. 多种贡献方式

  - 以开源项目产品为中心，结合产学研，可参与理论研究、业务建模、技术开发、项目管理、运营、投资、试用分享推广。
