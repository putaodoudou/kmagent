...
[KMAgent](http://kmagent.com) 以 **个人知识管理 GTD** 应用为主的个人工具软件。基于交互区+文档的协同学习工作空间，专注于语义计算、知识工程。致力于通过最新技术+社群协同，简化知识增强认知、融合支持优秀方法论模板，辅助高效学习工作，增强个人能力，协同积累创新，节省时间精力，从知识中挖掘智慧。您的私人知识引擎、秘书、智友、智囊团。
...
- **实现应对人工智能**，知识与智能相辅相成，知识管理作为一个核心环节，承上启下形成闭环，社群协同积累创新。
- **作为爱好**，为自己开发一个工具，重新造个轮子，自然交互降低工具学习使用成本。
- **作为事业**，一个值得奋斗十年的事业。Do something diferent, make a change!

![人类与人工智能](./assets/images/contrast.png)

## 【产品简介】产品原型正火速开发中！

> **以产品应用为主**，开源项目结合学研，理论技术知识能力实践闭环正反馈迭代积累的过程，人与人与机器机器的合作学习！

是以文档+交互区为中心的功能集成，资源事务行为的协同智能管理GTD。首先用于协同建立核心概念理论体系，知识管理业务建模，积累分享资源知识技术，应用于KM、IT、AI、数学相关领域知识的整理。
...
> 我们是一个开放自由合作、快速成长的协同学习型组织，项目处于初期规划阶段，**欢迎各位有志之士的加入！**。
...
【值得加入】知识改变命运，创新改变世界！改变自己从心而为，不忘初心方得始终！ 寻求共同信念的一起持续积累创造价值。 欢迎每个人贡献力量并从中受益，你会得到比你想要的更多！期待您的加入！
...
展示【博客】: ['http://kmagent.com'](http://kmagent.com)  
工具【下载】: 待发布  
